...
A comprehensive overview image of the entire grid, composed of individual tiles arranged in a 5×5 grid pattern. The atlas provides spatial context and navigation reference for subsequent high-magnification data collection across the specimen grid.
