...
def upgrade() -> None:
    ...
    op.drop_index(op.f("idx_acquisition_id_hash"), table_name="acquisition", postgresql_using="hash")
    op.drop_index(op.f("idx_acquisition_id_pattern"), table_name="acquisition")
    op.drop_index(op.f("idx_acquisition_name"), table_name="acquisition")
    op.drop_index(op.f("idx_agent_connection_agent_id"), table_name="agentconnection")
    op.drop_index(op.f("idx_agent_connection_created_at"), table_name="agentconnection")
    op.drop_index(op.f("idx_agent_connection_heartbeat"), table_name="agentconnection")
    op.drop_index(op.f("idx_agent_connection_session_id"), table_name="agentconnection")
    op.drop_index(op.f("idx_agent_connection_status"), table_name="agentconnection")
    op.drop_index(op.f("idx_agent_instruction_acknowledged_at"), table_name="agentinstruction")
    op.drop_index(op.f("idx_agent_instruction_agent_id"), table_name="agentinstruction")
    op.drop_index(op.f("idx_agent_instruction_created_at"), table_name="agentinstruction")
    op.drop_index(op.f("idx_agent_instruction_expires_at"), table_name="agentinstruction")
    op.drop_index(op.f("idx_agent_instruction_priority"), table_name="agentinstruction")
    op.drop_index(op.f("idx_agent_instruction_sent_at"), table_name="agentinstruction")
    op.drop_index(op.f("idx_agent_instruction_sequence"), table_name="agentinstruction")
    op.drop_index(op.f("idx_agent_instruction_session_id"), table_name="agentinstruction")
    op.drop_index(op.f("idx_agent_instruction_status"), table_name="agentinstruction")
    op.drop_index(op.f("idx_agent_instruction_type"), table_name="agentinstruction")
    op.drop_index(op.f("idx_agent_ack_agent_id"), table_name="agentinstructionacknowledgement")
    op.drop_index(op.f("idx_agent_ack_created_at"), table_name="agentinstructionacknowledgement")
    op.drop_index(op.f("idx_agent_ack_instruction_id"), table_name="agentinstructionacknowledgement")
    op.drop_index(op.f("idx_agent_ack_processed_at"), table_name="agentinstructionacknowledgement")
    op.drop_index(op.f("idx_agent_ack_session_id"), table_name="agentinstructionacknowledgement")
    op.drop_index(op.f("idx_agent_ack_status"), table_name="agentinstructionacknowledgement")
    op.drop_index(op.f("idx_agent_session_acquisition_uuid"), table_name="agentsession")
    op.drop_index(op.f("idx_agent_session_agent_id"), table_name="agentsession")
    op.drop_index(op.f("idx_agent_session_created_at"), table_name="agentsession")
    op.drop_index(op.f("idx_agent_session_last_activity"), table_name="agentsession")
    op.drop_index(op.f("idx_agent_session_status"), table_name="agentsession")
    op.drop_index(op.f("idx_atlas_grid_uuid"), table_name="atlas")
    op.drop_index(op.f("idx_atlas_id_pattern"), table_name="atlas")
    op.drop_index(op.f("idx_atlastile_atlas_id"), table_name="atlastile")
    op.drop_index(op.f("idx_atlastile_id_pattern"), table_name="atlastile")
    op.drop_index(op.f("idx_foilhole_gridsquare_id"), table_name="foilhole")
    op.drop_index(op.f("idx_foilhole_id_hash"), table_name="foilhole", postgresql_using="hash")
    op.drop_index(op.f("idx_foilhole_id_pattern"), table_name="foilhole")
    op.drop_index(op.f("idx_foilhole_quality"), table_name="foilhole")
    op.add_column("grid", sa.Column("prediction_updated_time", sa.DateTime(), nullable=False))
    op.drop_index(op.f("idx_grid_acquisition_id"), table_name="grid")
    op.drop_index(op.f("idx_grid_name"), table_name="grid")
    op.drop_index(op.f("idx_grid_uuid_hash"), table_name="grid", postgresql_using="hash")
    op.drop_index(op.f("idx_grid_uuid_pattern"), table_name="grid")
    op.drop_index(op.f("idx_gridsquare_grid_uuid"), table_name="gridsquare")
    op.drop_index(op.f("idx_gridsquare_id_hash"), table_name="gridsquare", postgresql_using="hash")
    op.drop_index(op.f("idx_gridsquare_id_pattern"), table_name="gridsquare")
    op.drop_index(op.f("idx_micrograph_foilhole_id"), table_name="micrograph")
    op.drop_index(op.f("idx_micrograph_id_hash"), table_name="micrograph", postgresql_using="hash")
    op.drop_index(op.f("idx_micrograph_id_pattern"), table_name="micrograph")
    op.add_column("qualityprediction", sa.Column("metric_name", sqlmodel.sql.sqltypes.AutoString(), nullable=True))
    op.drop_index(op.f("idx_quality_prediction_foilhole_uuid"), table_name="qualityprediction")
    op.drop_index(op.f("idx_quality_prediction_gridsquare_uuid"), table_name="qualityprediction")
    op.drop_index(op.f("idx_quality_prediction_model_foilhole"), table_name="qualityprediction")
    op.drop_index(op.f("idx_quality_prediction_model_gridsquare"), table_name="qualityprediction")
    op.drop_index(op.f("idx_quality_prediction_model_name"), table_name="qualityprediction")
    op.drop_index(op.f("idx_quality_prediction_timestamp"), table_name="qualityprediction")
    op.drop_index(op.f("idx_quality_prediction_value"), table_name="qualityprediction")
    ...
    op.drop_index(op.f("idx_quality_model_param_composite"), table_name="qualitypredictionmodelparameter")
    op.drop_index(op.f("idx_quality_model_param_grid_uuid"), table_name="qualitypredictionmodelparameter")
    op.drop_index(op.f("idx_quality_model_param_key"), table_name="qualitypredictionmodelparameter")
    op.drop_index(op.f("idx_quality_model_param_model_name"), table_name="qualitypredictionmodelparameter")
    op.drop_index(op.f("idx_quality_model_param_timestamp"), table_name="qualitypredictionmodelparameter")
    ...
    op.drop_index(op.f("idx_quality_model_weight_grid_model"), table_name="qualitypredictionmodelweight")
    op.drop_index(op.f("idx_quality_model_weight_grid_uuid"), table_name="qualitypredictionmodelweight")
    op.drop_index(op.f("idx_quality_model_weight_micrograph_model"), table_name="qualitypredictionmodelweight")
    op.drop_index(op.f("idx_quality_model_weight_micrograph_uuid"), table_name="qualitypredictionmodelweight")
    op.drop_index(op.f("idx_quality_model_weight_model_name"), table_name="qualitypredictionmodelweight")
    op.drop_index(op.f("idx_quality_model_weight_quality"), table_name="qualitypredictionmodelweight")
    op.drop_index(op.f("idx_quality_model_weight_timestamp"), table_name="qualitypredictionmodelweight")
    op.drop_index(op.f("idx_quality_model_weight_value"), table_name="qualitypredictionmodelweight")
